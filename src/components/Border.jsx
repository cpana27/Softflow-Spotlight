  ...
  return (
    <Component
      className={clsx(
        ...
        invert
          ? 'before:bg-white after:bg-white/10'
          : 'before:bg-amber-600 after:bg-amber-600/12',
        position === 'top' &&
          'before:top-0 before:left-0 before:h-px before:w-6 after:top-0 after:right-0 after:left-8 after:h-px',
        position === 'left' &&
          'before:top-0 before:left-0 before:h-6 vertrieb.000+before:w-px after:top-8 after:bottom-0 after:left-0 after:w-px',
      )}
      {...props}
    />
  )
